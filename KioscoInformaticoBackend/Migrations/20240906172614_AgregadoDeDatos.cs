        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, "0000003100010000000004", 2, "Calle 4", 3, "Proveedor D", "444444444" },
                    ...
                    { 8, "0000003100010000000008", 6, "Calle 8", 1, "Proveedor H", "888888888" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, new DateTime(2021, 5, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 10, 2, 2000 },
                    { 3, new DateTime(2021, 5, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 5, 3, 3000 },
                    { 4, new DateTime(2021, 5, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, 0, 4, 4000 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 9, 6, 14, 26, 13, 530, DateTimeKind.Local).AddTicks(2174), 0, 21m, 3000m },
                    { 2, 2, new DateTime(2024, 9, 6, 14, 26, 13, 530, DateTimeKind.Local).AddTicks(2186), 1, 10m, 5000m },
                    { 3, 3, new DateTime(2024, 9, 6, 14, 26, 13, 530, DateTimeKind.Local).AddTicks(2189), 2, 21m, 8000m },
                    { 4, 4, new DateTime(2024, 9, 6, 14, 26, 13, 530, DateTimeKind.Local).AddTicks(2191), 3, 0m, 10000m }
                });
