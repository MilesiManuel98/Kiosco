...
namespace KioscoInformaticoBackend.Migrations
{
    ...
    [Migration("20240906172614_AgregadoDeDatos")]
            ...
            modelBuilder.Entity("KioscoInformaticoBackend.Models.Venta", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClienteId = 1,
                            Fecha = new DateTime(2024, 9, 6, 14, 26, 13, 530, DateTimeKind.Local).AddTicks(2174),
                            FormaPago = 0,
                            Iva = 21m,
                            Total = 3000m
                        },
                        new
                        {
                            Id = 2,
                            ClienteId = 2,
                            Fecha = new DateTime(2024, 9, 6, 14, 26, 13, 530, DateTimeKind.Local).AddTicks(2186),
                            FormaPago = 1,
                            Iva = 10m,
                            Total = 5000m
                        },
                        new
                        {
                            Id = 3,
                            ClienteId = 3,
                            Fecha = new DateTime(2024, 9, 6, 14, 26, 13, 530, DateTimeKind.Local).AddTicks(2189),
                            FormaPago = 2,
                            Iva = 21m,
                            Total = 8000m
                        },
                        new
                        {
                            Id = 4,
                            ClienteId = 4,
                            Fecha = new DateTime(2024, 9, 6, 14, 26, 13, 530, DateTimeKind.Local).AddTicks(2191),
                            FormaPago = 3,
                            Iva = 0m,
                            Total = 10000m
                        });
